...
export const OPT_TATLI_KRUVASAN_SECIMI: OptionGroup = {
  ...
  options: [
    ...
    { id: "kruv-mangolu-danish", option_group_id: "opt-tatli-kruvasan-secimi", name: "Mangolu Danish", price_modifier: 40, display_order: 7 },
    { id: "kruv-antep-fistikli", option_group_id: "opt-tatli-kruvasan-secimi", name: "Antep Fıstıklı Kruvasan", price_modifier: 40, display_order: 8 },
    { id: "kruv-lotuslu", option_group_id: "opt-tatli-kruvasan-secimi", name: "Lotuslu (Lotus Cruffin / Lotus seçimi)", price_modifier: 40, display_order: 9 },
  ],
};
...
export const OPT_IKILI_TATLI_SECIMI: OptionGroup = {
  ...
  options: [
    ...
    { id: "ikili-mango-danish", option_group_id: "opt-ikili-tatli-secimi", name: "Mangolu Danish", price_modifier: 40, display_order: 4 },
    { id: "ikili-antep-fistikli", option_group_id: "opt-ikili-tatli-secimi", name: "Antep Fıstıklı Kruvasan", price_modifier: 40, display_order: 5 },
    { id: "ikili-lotus", option_group_id: "opt-ikili-tatli-secimi", name: "Lotuslu (Lotus Cruffin / Lotus seçimi)", price_modifier: 40, display_order: 6 },
    { id: "ikili-cilekli-nutella", option_group_id: "opt-ikili-tatli-secimi", name: "Çilekli Muzlu Nutellalı Kruvasan", price_modifier: 0, display_order: 7 },
    { id: "ikili-cilekli-kremali", option_group_id: "opt-ikili-tatli-secimi", name: "Çilekli Muzlu Kremalı Kruvasan", price_modifier: 0, display_order: 8 },
    { id: "ikili-limon-danish", option_group_id: "opt-ikili-tatli-secimi", name: "Limonlu Danish", price_modifier: 0, display_order: 9 },
    { id: "ikili-cilek-danish", option_group_id: "opt-ikili-tatli-secimi", name: "Çilekli Danish", price_modifier: 0, display_order: 10 },
    { id: "ikili-antep-twissy", option_group_id: "opt-ikili-tatli-secimi", name: "Antep Fıstıklı Twissy", price_modifier: 0, display_order: 11 },
    { id: "ikili-limon-twissy", option_group_id: "opt-ikili-tatli-secimi", name: "Limonlu Twissy", price_modifier: 0, display_order: 12 },
    { id: "ikili-cikolata-twissy", option_group_id: "opt-ikili-tatli-secimi", name: "Sütlü Belçika Çikolatalı Twissy", price_modifier: 0, display_order: 13 },
...
export const OPT_OZELLESTIRME_SECENEKLERI: OptionGroup = {
  ...
  options: [
    ...
    { id: "opt-mangolu-danish", option_group_id: "opt-ozellestirme-secenekleri", name: "Mangolu Danish", price_modifier: 40, display_order: 4 },
    { id: "opt-antep-fistikli-kruvasan", option_group_id: "opt-ozellestirme-secenekleri", name: "Antep Fıstıklı Kruvasan", price_modifier: 40, display_order: 5 },
    { id: "opt-lotuslu", option_group_id: "opt-ozellestirme-secenekleri", name: "Lotuslu (Lotus Cruffin / Lotus seçimi)", price_modifier: 40, display_order: 6 },
  ],
};
